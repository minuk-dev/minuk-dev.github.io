...
## 15주차
### 행복심리학, 긍정심리학
 * 예전에는 인간의 부정적 측면 중심으로 연구를 했음.
 * 인간의 긍정적인 측면도 바라보자 -> Martin Seligman(마틴 셀리그만), 예전에 학습된 무기력 실험한 사람

### 행복이란?
 * 과거에는 객관적 지표(GNP, GDP, 평균 수명 등)을 기반해서 연구하려고 했었음.
 * 2등보다 3등이 행복해 한다. -> 주관적으로 받아들인다.
 * Kahneman의 대장 내시경 검사
   * 5분 정상 검사 vs 5분 정상검사 + 가짜 검사 1분
   * 가짜검사 1분이 있는 그룹이 기억이 왜곡되어, 재검사에 동의한다.
   * 모든 일에는 마무리가 중요하다
 * 디너 : 중요한 것은 객관적 사건이 아니라 객관적 세상에 대한 우리의 해석이다.
   * 감정 상태 (긍정적 감정의 존재 + 부정적 정서의 부재)
   * 인지적 판단 : 자신의 삶에 만족함

## 왜 행복해야 하는가?
### 미국 수녀원 사례
 * 행복하게 글을 쓴 사람은 상대적으로 오래 살았다.
 * 수녀들은 다른 환경이 거의 비슷한데, 수명이 차이가 났다.

### 행복한 사람이 수입이 높다.
### 1960년도 졸업앨범연구
 * 뒷샘 미소 (진짜 미소 vs 가짜 미소)
 * 행복한 사람이 더 만족한 결혼생활

### 불행은 사고-행동의 폭을 좁힌다.
 * Narrowing attention (좁은 집중)
 * Quick decision making (빠른 판단)
 * Quick action or response (빠른 행동)

### 행복은 사고-행동의 폭을 넓힌다.

#### 행복한 사람은 발전하게 된다.
 * 긍정적 정서 경험 -> 일시적 사고-확장 레퍼토리의 확장 -> 지속적 개인

#### 행복한 사람이 더 이타적이다.
 * Spreading Happiness

### 행복수준은 어떻게 바꿀것인가?(genetic and external influence)
#### 쌍둥이 연구
 * 이란성 쌍둥이보다 일란성 쌍둥이가 더 행복의 정도가 비슷하다
 * "행복이라는 것은 키를 크려는 것과 비슷하다"
 * 유전이 50% 정도의 영향을 가진다.

#### 돈이 행복을 만들 수 있는가?
 * 일정 수준을 넘어가면 돈은 유의미하지 않다.
 * 나라별 GNP와 행복정도 비교. 그 당시 1위였던 일본이 행복수준이 높지 않았다.
 * 로이 카플란의 복권당첨자 연구
 * 강한 행복 경험의 영향
   * 높은 점수를 한번 받은 사람은 중간점수에 행복을 못느끼게 한다.

#### 행복은 강도가 아니라 빈도이다.
 * 고빈도 저강도로 행복을 느낀 사람이 행복 점수가 높다.

#### 물질로 행복할수 없는 이유
 * 적응(Adaptation), 기대 증가(Rising Expectation)
 * 행복한 삶을 살기 위해 필요한 물건의 목록을 작성하게 했을 때, 그러한 물건을 갖고 있는 사람들의 목록이 더 길었다.

### 외모가 행복을 만드는 가?
 * 외모가 행복도를 결정하지는 않는다.
 * 단, 여성의 경우 외모 데이트 횟수과 비례하긴 했다.

 * 외모를 중요시한다면 불행할 가능성이 더 높다.

### 행복의 주관성 : Subjective well-being
 * 객관적 현실을 바꾸는 것이 아니라 지각을 바꾸어야 한다.

#### Step 1. 좋은점 보기 - perception
 * The Merit-finder : 좋은점 보기 -> 상대적으로 더 행복해질수 있다.
 * The Fault-finder : 나쁜점 보기
...
#### Step 3. 실패의 해석
 * 시도하지 않으면 된다. -> 실패는 피해야할것이 아니라 성공으로 가야할때 필요한 것이다.

#### Step 4. 미루기 극복 & 몰입(flow)
 * 몰입할 수 있으려면 너무 쉬운것도(따분) 너무 어려운것도(불안, 좌절) 아닌 적당한 것을 해야한다.

#### Step 5. 웃으면 행복해진다.
 * 안면피드백 이론 : 근육이 신호를 보낸다.

#### Step 6. 감사하기

#### Step 7. 사랑과 우정
 * 행복 상위 10%는 사회적 관계가 좋았다.
   * 혼자 있는 시간이 적다
   * 대인관계가 좋다
   * 1명을 제외하고 모두 애인이 있다
